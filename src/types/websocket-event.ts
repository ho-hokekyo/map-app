...
export type websocketEventType =
    ...
    | 'new friend request cancelled'
    | 'new friend request ignored'
    | 'new friend request blocked'
    | 'new friend request unblocked'
    | 'new friend request unignored'
    | 'new friend request unaccepted'
    | 'new friend request unrejected';
